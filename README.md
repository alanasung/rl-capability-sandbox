<p align="center">
  ...
  <p align="center">SPAR Fall 2026 · <a href="https://github.com/alanasung/rl-capability-sandbox">Capability Emergence in a Tiny RL Sandbox</a></p>
</p>
...
**Capability Emergence in a Tiny RL Sandbox**. The shared engineering spine (config, caching, hooks, metrics,
...
| Stage | Module | Output |
|---|---|---|
| Compose config | `configs/` + `rlsand.configs` | resolved `config.yaml` |
| Build data | `rlsand.data` | splits + manifest |
| Load model | `rlsand.models` | `LoadedModel` + resolved commit |
| Run stages | `scripts/run_experiment.py` | per-stage JSON |
| Aggregate | `rlsand.reporting` | `results.json` + tables + figures |
...
├── src/rlsand/       # installable library (print-free)
...
- SPAR Fall 2026 project posting: https://github.com/alanasung/rl-capability-sandbox
- Complexity bar: Critical Data PRIMED-AI / RecursiveJEPA engineering standard

## Citation

```bibtex
@misc{rlsand_spar_f26,
  title        = {Capability Emergence in a Tiny RL Sandbox},
  author       = {Alana Sung},
  year         = {2026},
  howpublished = {SPAR Fall 2026},
  note         = {Measure whether small-model RL in a constrained deduction sandbox produces transferable capability jumps.},
  url          = {https://github.com/alanasung/rl-capability-sandbox}
}
```
...
Ablations live under `src/rlsand/ablation/` and return structured dicts. Presets

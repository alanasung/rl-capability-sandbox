"""Experiment stages for Capability Emergence in a Tiny RL Sandbox."""
...
from .rlsand._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(
        out / "report.json",
        {"headline": "Capability Emergence in a Tiny RL Sandbox", "claims_gated": True},
    )
